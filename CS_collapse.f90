subroutine CS_collapse
  ...
  double precision f_n,f_p,f_p_n,f_p_p,start(3),end(3),wtr,b0,beta_tot
...
!  b_y=B0*tanh(mask/wtr)
  b_y=B0*exp(-(mask/wtr)**2)
  b_z=0.0d0
  vx_h=0.0d0;vy_h=0.0d0;vz_h=0.0d0
  vx_m=0.0d0;vy_m=0.0d0;vz_m=0.0d0
  p_tot=0.5d0*(B0**2-b_y**2)+1.0d0/gm*beta
!  p_tot=beta*2.0d0/B0**2
  
!  f_p_p=gm*beta*B0**2/2.0d0
!  f_p_n=1.0d0-f_p_p  
!  f_p=f_p_p/(1.0d0-f_p_p)
!  f_n=1.0d0-f_p
!  n_fraction=f_n
