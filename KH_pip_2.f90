subroutine KH
  ...
  use globalvar,only:ix,jx,kx,U_h,U_m,flag_bnd,beta,flag_b_stg,dtout,&
       ...
       x,y,z,dx,dy,dz,n_fraction,gra,flag_grav,scl_height,margin,flag_damp
  ...
  double precision Atwood,ro_l,ro_u,vx_l,vx_u,w_lay,b0
