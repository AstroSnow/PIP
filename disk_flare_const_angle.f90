...
!! Ref: Miller & Stone 1997
subroutine disk_flare_const_angle
  ...
  double precision :: sseps = 0.2d0, npol = 3.d0, &
       eth = 2.d-3, emg = 1.d-4, tec0 = 1.d0, roc0 = 1.d-3
  double precision :: angle_op = pi/36.d0
  double precision :: r_start = 1.d0 ! length unit (stellar radius)
  double precision :: vk_star = 1.d0 ! velocity unit (Kepler velocity at r=r_star)
  double precision :: Hp(ix) ! pressure scale height of the disk Hp(r)
  ...
  integer :: i,j,ibnd,ierr,flag_err_NUG
...
end subroutine DISK_FLARE_CONST_ANGLE
