...
line2, = ax.plot(np.log10(temperature),loss2/np.max(loss2),linewidth=3,label='Modified (c=0.1)')
...
#savename=('Figures/lossfun_plot_custom.png')
...
hf = h5py.File('lossfunc_scott_mod.h5', 'w')

hf.create_dataset('temperature', data=temperature)
hf.create_dataset('rad_loss', data=loss2)
