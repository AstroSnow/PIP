...
cp=ax.contourf(tarr,yg,np.log10(intensarr_si4[:,:].T),levels=cvels2,cmap='magma',extend='both')
ax2.set_facecolor('k')
cp2=ax2.contourf(tarr,yg,np.log10(intensarr_mg2[:,:].T),levels=cvels,cmap='inferno',extend='both')
